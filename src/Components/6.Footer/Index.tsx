    ...
    return (
        ...
        <div className="mx-auto max-w-2xl pt-24 px-4 sm:px-6 lg:max-w-7xl lg:px-8 align-center">
            <div className="my-12 grid grid-cols-1 gap-y-10 sm:grid-cols-6 lg:grid-cols-12 ">
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1801340.7893762237!2d-83.80103459399531!3d28.139067606627886!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x257b4770ba400b1%3A0x73272807e13b1ce1!2sLocksPro%20LLC!5e0!3m2!1sen!2seg!4v1712087001321!5m2!1sen!2seg" width="100%" height="450" style={{border:"0"}} allowFullScreen  loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
            ...
            <div className='py-10 md:flex items-center justify-center border-t border-t-bordertop'>
                <h4 className='text-darkgrey text-sm text-center md:text-start font-normal'>@2022 - Lock Pro LLC. All Rights Reserved.</h4>
