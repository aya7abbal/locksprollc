          ...
          <div className="col-span-6 flex flex-col justify-center">
            ...
            >
              <p className="text-grey md:text-lg font-normal mb-10 text-start mt-2">
                We cover Florida and all surrounding areas. Locks Pro CA offers
              ...
              <div className="flex align-middle justify-center md:justify-start">
                <a className="text-xl font-medium rounded-full text-white py-5 px-6 bg-red-400 lg:px-10 mr-6" href="tel:001619-826-9574">
                 Call Us Now!
                </a>
              </div>
            </Fade>
