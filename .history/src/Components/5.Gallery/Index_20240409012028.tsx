...
import CarFour from "../../assets/Images/Gallery/Car7.jpg"
import CarTwo from "../../assets/Images/Gallery/Car2.jpg"
import CarThree from "../../assets/Images/Gallery/Car2.jpeg"
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 my-16 sm:space-x-6 space-y-6 md:space-y-0 px-6" >
          ...
          <div className="col-span-6 flex justify-center">
            <div className="grid grid-rows-1 grid-flow-row gap-4">
              <div className="row-span-1 overflow-hidden rounded-3xl" style={{height:"700px"}}>
                <img
                  src={CarTwo}
                  alt="pizza-two"
                  // width={700}
