...
import CarOne from "../../assets/Images/Gallery/Car4.jpg"
          ...
          <div className="col-span-6 flex justify-center">
            <div className="grid grid-rows-1 grid-flow-row gap-4">
              <div className="row-span-1 overflow-hidden rounded-3xl">
                <img
                  src="../../assets/Images/Gallery/Car5.jpg"
                  alt="pizza-two"
                  width={700}
                  height={405}
                  className="inner-img"
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="overflow-hidden rounded-3xl">
                  <img
                    src="../../assets/Images/Gallery/Car3.jpg"
                    alt="pizza-three"
                    width={500}
                    height={405}
                    className="inner-img"
                ...
                <div className="overflow-hidden rounded-3xl">
                  <img
                    src="../../assets/Images/Gallery/Car1.jpg"
                    alt="pizza-four"
                    width={500}
                    height={405}
                    className="inner-img"
