...
import BannerPhoto from "../../../public/images/Banner/Mobile-Lockout.jpeg";
import "./Banner.css";

const Banner = () => {
  return (
    <div id="home-section" className="bg-lightpink w-100">
            ...
            >
              <div className="md:flex align-middle justify-center lg:justify-start">
                <button className="text-xl w-full md:w-auto font-medium rounded-full text-white py-5 px-6 bg-pink lg:px-14 mr-6">
                  <Link href="tel:001619-826-9574">Call Us Now</Link>
                </button>
