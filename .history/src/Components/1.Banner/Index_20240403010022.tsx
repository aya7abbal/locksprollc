...
const Banner = () => {
  return (
    <div className="bg-lightpink w-100 mt-32">
      <div className="mx-auto max-w-7xl pt-20 sm:pb-24 px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 space-x-1">
          <div className="col-span-6 flex flex-col justify-center">
            ...
            >
              <div className="md:flex align-middle justify-center lg:justify-start">
                <button className="text-xl w-full md:w-auto font-medium rounded-full text-white py-5 px-6 bg-rose-400 lg:px-14 mr-6">
                  <a href="tel:001619-826-9574">Call Us Now</a>
                </button>
                <button className="flex border w-full md:w-auto mt-5 md:mt-0 border-pink justify-center rounded-full text-xl font-medium items-center py-5 px-10 text-rose-400 hover:text-white hover:bg-rose-400">
          ...
          <div className="col-span-6 flex justify-center relative banner-photo-container">
