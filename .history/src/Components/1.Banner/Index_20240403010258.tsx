          ...
          <div className="col-span-6 flex flex-col justify-center">
            ...
            >
              <div className="md:flex align-middle justify-center lg:justify-start">
                <button className="text-xl w-full md:w-auto font-medium rounded-full text-white py-5 px-6 bg-red-300 lg:px-14 mr-6">
                  <a href="tel:001619-826-9574">Call Us Now</a>
                </button>
                <button className="flex border w-full md:w-auto mt-5 md:mt-0 border-pink justify-center rounded-full text-xl font-medium items-center py-5 px-10 text-red-300 hover:text-white hover:bg-red-300">
