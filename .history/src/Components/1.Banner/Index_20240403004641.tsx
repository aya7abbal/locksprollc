          ...
          <div className="col-span-6 flex flex-col justify-center">
            ...
            >
              <div className="md:flex align-middle justify-center lg:justify-start">
                <button className="text-xl text-stone-500 w-full md:w-auto font-medium rounded-full text-white py-5 px-6 bg-pink lg:px-14 mr-6">
                  <a href="tel:001619-826-9574">Call Us Now</a>
                </button>
                <button className="text-stone-500 text-xl hover:text-white hover:bg-black">
