...
import Automotive from '../../assets/Images/Services/featureTwo.jpg'
import Commercial from '../../assets/Images/Services/featureThree.jpg'
        ...
        <div>
            <div className='mx-auto max-w-7xl py-20 px-6' id="services-section">
                <div className='text-center mb-14' >
                    <Fade direction={'up'} delay={0} cascade damping={1e-1} triggerOnce={true}>
                        <h3 className='text-red-400 text-lg font-normal mb-3 ls-51 uppercase'>Our Services</h3>
                    </Fade>
                    <Fade direction={'up'} delay={0} cascade damping={1e-1} triggerOnce={true}>
                        ...
                        {cardData.map((items, i) => (
                            ...
                            <div className='card-b p-8 relative rounded-3xl my-5' key={i}>
                                ...
                                <div className='flex items-center justify-center'>
                                    {/* <Link href='/'><p className='text-center text-lg font-medium text-red-400 mt-2 hover-underline'>{items.link}<ChevronRightIcon width={20} height={20} /></p></Link> */}
                                </div>
