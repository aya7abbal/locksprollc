...
import HappyCustomer from "../../../public/images/Mission/Happy customer.jpeg";
import Burger from "../../../public/images/Mission/burger.png";
      ...
      <div className="mx-auto max-w-7xl lg:pt-20 sm:pb-24 px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 my-16 space-x-5">
          <div className="col-span-6 flex justify-start">
            <Image src={HappyCustomer} alt="nothing" width={900} height={808} />
          </div>
          ...
          <div className="col-span-6 flex flex-col justify-center">
            <Fade
              ...
              triggerOnce={true}
            >
              <h2 className="text-pink text-lg font-normal my-3 ls-51 uppercase text-start">
                {" "}
                What We Do
              </h2>
            </Fade>
            ...
            >
              <p className="text-grey md:text-lg font-normal mb-10 text-start mt-2">
                We cover Ontario and all surrounding areas. Locks Pro CA offers
              ...
              <p className="text-grey md:text-lg font-normal mb-10 text-start mt-1">
                ...
                thousands of happy customers. We are fast in emergencies, give us
                a call and we&apos;ll be right there!
              </p>
              <div className="flex align-middle justify-center md:justify-start">
                <a className="text-xl font-medium rounded-full text-white py-5 px-6 bg-pink lg:px-10 mr-6" href="tel:001619-826-9574">
                 Call Us Now!
                </a>
              </div>
            </Fade>
