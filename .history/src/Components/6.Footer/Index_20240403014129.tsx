...
const socialLinks: socialLinks[] = [
    ...
    {
        imgSrc: '../../assets/Images/Footer/insta.svg',
        link: 'https://www.instagram.com/locksprollc/',
        width: 14
    },
    {
        imgSrc: '../../assets/Images/Footer/yelp.svg',
            ...
            <div className="my-12 grid grid-cols-1 gap-y-10 sm:grid-cols-6 lg:grid-cols-12 ">
                ...
                <div className='sm:col-span-6 lg:col-span-5'>
                    <div className="flex flex-shrink-0 items-center border-right ">
                        <img src="/images/Logo/Logo.png" alt="logo" width={56} height={56} />
                    ...
                    <div className='flex gap-4'>
                        ...
                        <a href={items.link} key={i}>
                            <div className="bg-white h-10 w-20 shadow-xl text-base rounded-full flex items-center justify-center footer-icons hover:bg-pink">
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1801340.7893762237!2d-83.80103459399531!3d28.139067606627886!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x257b4770ba400b1%3A0x73272807e13b1ce1!2sLocksPro%20LLC!5e0!3m2!1sen!2seg!4v1712087001321!5m2!1sen!2seg" width="600" height="450" style={{border:"0"}} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
