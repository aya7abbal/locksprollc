            ...
            {postData.map((items, i) => (
              <div className="justify-center" key={i}>
                <div className="m-3 py-14 my-2 text-center ">
                  ...
                  {items.name !== "GIVE US A CALL" ? items.profession : `${items.profession.split('on')[0]} on `} 
                  {items.name === "GIVE US A CALL" && <a href='tel:0013213351279' className="text-red-400">(321)-335-1279</a>}
                  {items.name === "GIVE US A CALL" && items.profession.split('Call us on')[1]}
                  </h4>
                </div>
              </div>
            ))}
