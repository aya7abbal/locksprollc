...
const postData: DataType[] = [
  ...
  {
    name: "GIVE US A CALL",
    profession: `Call us on and we will be there as soon as possible.`,
    imgSrc: Call,
  },
  {
    name: "QUICK SAVE",
  ...
  console.log(<a href="tel:0013213351279">(321)-335-1279</a>)
// CAROUSEL SETTINGS
export default class MultipleItems extends Component {
  ...
  console.log(postData[1].profession.split('Call us on')[0])
            ...
            {postData.map((items, i) => (
              <div className="justify-center" key={i}>
                <div className="m-3 py-14 my-2 text-center ">
                  ...
                  {items.name !== "GIVE US A CALL" ? items.profession : items.profession.split('Call us on')[0]}
                  { items.name === "GIVE US A CALL" && <a href='tel:0013213351279'>(321)-335-1279</a>}
                  {items.name !== "GIVE US A CALL" ? items.profession : items.profession.split('Call us on')[1]}
                  </h4>
                </div>
              </div>
            ))}
