            ...
            {postData.map((items, i) => (
              <div className="justify-center" key={i}>
                <div className="m-3 py-14 my-2 text-center ">
                  ...
                  <a href='tel:0013213351279'>(321)-335-1279</a>
                    {items.name !== "GIVE US A CALL" ? items.profession : items.profession.replace('numberPlaceHolder',`${<a href='tel:0013213351279'>(321)-335-1279</a>}`)}
                  </h4>
                </div>
              </div>
            ))}
