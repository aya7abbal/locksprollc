...
const postData: DataType[] = [
  ...
  {
    name: "GIVE US A CALL",
    profession: `Call us on numberPlaceHolder and we will be there as soon as possible.`,
    imgSrc: Call,
  },
  {
    name: "QUICK SAVE",
              ...
              <div className="justify-center" key={i}>
                <div className="m-3 py-14 my-2 text-center ">
                  ...
                  <h4 className="text-lg font-normal text-lightblack pt-4 pb-2 opacity-50">
                    {items.name === "GIVE US A CALL" ? 'test1' : items.profession.replace('numberPlaceHolder','test')}
                    {/* {items.name === "GIVE US A CALL" ? items.profession : items.profession.replace('numberPlaceHolder','test')} */}
                  </h4>
                </div>
              </div>
            ))}
